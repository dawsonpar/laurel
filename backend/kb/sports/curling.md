...
## Rules
A standard Olympic men's or women's match runs 10 ends; mixed doubles runs 8. Each traditional team has four players delivering two stones each per end, 16 total. The team throwing the last stone holds the hammer, a strategic edge. The first-end hammer is set by a Last Stone Draw: two players from each side throw to the button, shorter combined distance wins. After that, the team giving up points loses the hammer next end.

The four positions are lead (stones one and two), second (three and four), third or vice-skip (five and six), and fourth, often the skip. The skip is the on-ice strategist, standing in the far house calling line and weight; the third holds the broom when the skip throws. Lead and second do most of the sweeping. The house has rings at 12-foot, 8-foot, 4-foot, and the button at center; only stones touching the 12-foot score. The hogline is the line a stone must fully cross to stay in play and the thrower must release before. A stone fully past the back line is removed.
...
- **Hammer:** Right to throw the final stone of an end.
- **House:** Bullseye target of concentric rings at each end of the sheet.
- **Button:** Small circle at the center of the house.
- **Biter:** Stone barely touching the outer edge of the 12-foot ring.
- **Guard:** Stone in front of the house, protecting another or blocking a path.
- **Draw:** Finesse shot meant to stop at a specific spot.
- **Takeout:** Shot heavy enough to remove an opponent's stone.
- **Hit:** General term for a takeout.
- **Peel:** Heavy takeout that removes both target and thrown stone.
- **Double-takeout:** Single shot that removes two opposing stones.
- **Freeze:** Draw that stops touching another stone without moving it.
- **Raise:** Bumping your own stone forward with another.
- **Hogline:** Line a stone must cross at the far end and release before at the near end.
- **Tee line (T-line):** Line through the center of the house, side to side.
- **Back line:** Tangent to the back of the 12-foot; a stone fully past is out.
- **Sweep:** Brushing the ice in front of a moving stone to reduce friction.
- **Slider:** Slick sole on a curler's delivery shoe.
- **Gripper:** Textured sole on the other shoe, for traction.
- **Skip:** Team's strategist; calls shots, usually throws last.
- **Lead:** Throws stones one and two.
- **Second:** Throws stones three and four.
- **Third (vice-skip):** Throws five and six; helps call strategy.
- **Fourth:** Throws the final two; often, but not always, the skip.
- **Free Guard Zone:** Area between hogline and tee line outside the house where opponent stones are protected during the first five stones of an end.
- **Blank end:** End with no points scored; hammer carries over.
- **Hammer advantage:** Strategic edge from throwing last.
- **Burned stone:** Moving stone touched by a player or broom in violation.
- **Double-touch:** Contacting the running stone with the hand after release.
...
To read the score, find the stone closest to the button. That team scores, getting a point for every additional stone closer than the nearest opposing one. If the nearest opposing stone sits between two of yours, you score one. A stone barely touching the outer ring is a biter and still counts.

You can usually tell the shot type before it arrives. A guard is thrown softly and stops short of the house. A draw glides slowly and curls noticeably as it nears the house. A takeout travels visibly faster, curls less, and is aimed at an opposing stone, often clearing it out of play.
