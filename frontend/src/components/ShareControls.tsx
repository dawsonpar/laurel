    ...
    return (
      <div className="flex flex-col gap-2">
        <button
          ...
          onClick={generate}
          disabled={saving}
          className="inline-flex items-center justify-center gap-2 self-start rounded-full border border-border bg-background px-4 py-2 text-xs font-medium text-muted transition hover:border-gold hover:text-gold-deep disabled:opacity-50"
        >
          <svg
            width="14"
            height="14"
